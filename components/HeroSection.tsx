        ...
        <div className='flex items-center justify-between max-sm:flex-col-reverse gap-y-10 px-4 mt-10 lg:px-44 sm:mt-20'>
            <div >
                ...
                <p className='my-6 text-[15px] text-gray-500'>
                    Effortlessly remove backgrounds from images with our BG Remover tool. Simply upload your image, and it will instantly process  <br />to give you a clean, transparent background. Ideal for presentations, e-commerce, marketing materials, and more! </p>
