...
function Steps() {
    ...
    return (
        <div className='mx-4 lg:mx-44 py-20 xl:py-40'>
            <h1 className='text-center text-2xl md:text-3xl lg:text-4xl mt-4 font-semibold sm:bg-gradient-to-r sm:from-gray-900 sm:to-gray-400 sm:bg-clip-text text-gray-500 sm:text-transparent'>Steps to remove background <br /> image in seconds</h1>
